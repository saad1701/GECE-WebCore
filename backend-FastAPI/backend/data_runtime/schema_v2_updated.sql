...
-- ========== Staging Tables (with data columns) ==========
...
CREATE TABLE IF NOT EXISTS stg_CellProvenance (
    ...
    -- Data columns from GECE_Workbook_CellProvenance.xlsx
    Sheet TEXT,
    Address TEXT,
    ValueText TEXT,
    DataType TEXT,
...
CREATE TABLE IF NOT EXISTS stg_Formulas (
    ...
    repo_name TEXT NULL,
    ref_or_sha TEXT NULL,
    -- Data columns from GECE_ALL_Formulas.xlsx
    Class TEXT,
    Sheet TEXT,
    AddressOrName TEXT,
    FormulaA1 TEXT,
...
CREATE TABLE IF NOT EXISTS stg_Functions (
    ...
    repo_name TEXT NULL,
    ref_or_sha TEXT NULL,
    -- Data columns from GECE_Logic_and_Functions.xlsx
    Subroutine TEXT,
    Sub_Name TEXT,
    kind TEXT  -- derived: Sub or Function
);
...
CREATE TABLE IF NOT EXISTS stg_Comments (
    ...
    repo_name TEXT NULL,
    ref_or_sha TEXT NULL,
    -- Data columns from GECE_workbook_CellComments.xlsx
    Sheet TEXT,
    Cell TEXT,
    Comment TEXT
);
