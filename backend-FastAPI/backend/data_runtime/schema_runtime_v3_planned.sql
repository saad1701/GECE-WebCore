...
id INTEGER PRIMARY KEY, name TEXT, sheet_id INTEGER, ref_a1 TEXT, first_cell TEXT, last_cell TEXT, n_rows INTEGER, n_cols INTEGER, n_cells INTEGER, sample_value TEXT, category TEXT,
 clean_ref TEXT,
 range_type TEXT,
